...
export interface ClawdriveClientOptions {
  privateKey: CryptoKey;
  publicKey: CryptoKey;
  baseUrl?: string;
}

export class ClawdriveClient {
  private readonly privateKey: CryptoKey;
  private readonly publicKey: CryptoKey;
  private readonly baseUrl: string;

  constructor(options: ClawdriveClientOptions) {
  ...
  /**
   * Internal helper to make authenticated requests to the Clawdrive API.
   */
  ...
  /**
   * Download a file from Clawdrive.
   *
