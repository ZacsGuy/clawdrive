...
declare const DEFAULT_API_BASE_URL = "https://api.clawdrive.dev";
declare const HEADER_KEY_HASH = "x-clawdrive-keyhash";
declare const HEADER_TIMESTAMP = "x-clawdrive-timestamp";
declare const HEADER_NONCE = "x-clawdrive-nonce";
declare const HEADER_SIGNATURE = "x-clawdrive-signature";
declare const GRANT_ISSUER = "clawdrive";
