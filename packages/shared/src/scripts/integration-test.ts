/**
 * Integration test against a live Clawdrive deployment.
 * Usage: CLAWDRIVE_URL=https://www.clawdrive.sh npx tsx packages/shared/src/scripts/integration-test.ts
 */
import {
  generateKeyPair,
  exportPublicKey,
